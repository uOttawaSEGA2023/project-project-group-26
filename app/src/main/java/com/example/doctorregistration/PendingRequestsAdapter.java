...
/**
 *
 * The PendingRequestsAdapter class serves as the RecyclerView adapter,
...
public class PendingRequestsAdapter extends RecyclerView.Adapter<PendingRequestsAdapter.ViewHolder>{
    ...
    public PendingRequestsAdapter(List<PendingRequestItem> pendingRequestsList) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_item_pending_request, parent, false);
        return new ViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        final PendingRequestItem item = pendingRequestsList.get(position);
    ...
    public void updateStatusInFirestore(final String userId, final String newStatus) {
        DocumentReference userRef = db.collection("Pending Requests").document(userId);
